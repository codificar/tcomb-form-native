...
class Struct extends Component {
	...
	onChange(fieldName, fieldValue, path) {
		...
		// colocar mascara de telefone
	// 	if(path[0] == "phone"){
	// 		var maskPhone 	= "0";
	// 		maskPhone 		= value.phone + "";

	// 		// maskPhone = maskPhone.replace(/^(\d\d)(\d{5})(\d{4}).*/,"($1) $2-$3");
	// 		// maskPhone = maskPhone.replace(/^(\d\d)/,"($1)");
	// 		// value.phone = maskPhone;
	// 		// this.setState({ value }, () => {
	// 		// 	this.props.onChange(value, path);
	// 		// });
	// 		// maskPhone = maskPhone.replace(/^(.{4})(\d{1})(\d{4}).*/,"$1 $2 $3");
	// 		// value.phone = maskPhone;
	// 		// this.setState({ value }, () => {
	// 		// 	this.props.onChange(value, path);
	// 		// });

    //   // maskPhone = maskPhone.replace(/^(.{11})(\d{4}).*/,"$1-$2");
	...
	// // 		console.log(value.phone, maskPhone);
	// 	}
